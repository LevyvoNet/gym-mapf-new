...
//                        new id_rtdp("id_rtdp"),
                ...
                /* lvl 4 */
                {
                        new online_window("online_window__vi", 2, new vi("vi"), window_planner_vi),
                        new online_window("online_window_2_rtdp", 2, new vi("vi"), window_planner_rtdp),
//                        new online_window("online_window_2_effective_agents_vi", 2, new vi("vi"), window_planner_vi_effective_agents),
                }
        }
);
